...
export class Form extends Component <IModalForm> {
  ...
  constructor(protected container: HTMLFormElement, protected events: EventEmitter) {
    ...
    this._error = ensureElement<HTMLSpanElement>('.form__errors', this.container);
...
export class OrderForm extends Form {
  ...
  constructor(protected container: HTMLFormElement, protected events: EventEmitter) {
    ...
    this.payOnlineButton = ensureElement<HTMLButtonElement>('.button_online', this.container) ;
    this.payOnReceiptButton = ensureElement<HTMLButtonElement>('.button_cash', this.container);
